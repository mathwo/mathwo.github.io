...
$\implies (m+n)^2=b^2+c^2-2ab \implies \dfrac{b^4}{x^2}=b^2+c^2-2ab \implies x^2=\bbox[5px, border: 1px solid black]{\dfrac{b^4}{b^2+c^2-2ab}}$
...
$\implies AB=AE-BE=\bbox[5px, border: 1px solid black]{4-\sqrt{3}}$
...
It gets equality when $x=y=\bbox[5px, border: 1px solid black]{-\dfrac{1}{2}}$.

---

### 11/11/2021

#### $D$ is a point on side $BC$ of $\triangle{ABC} such that $AB=CD$, $\angle{BAD}=27^{\circ}$, $\angle{ABC}=42^{\circ}$, Prove $AB=AC$
...
$\bbox[5px, border: 1px solid black]{ke_{k}=e_{k-1}p_{1}-e_{k-2}p_{2}+...+(-1)^{k-1}e_{0}p_{k}=\displaystyle \sum_{i=1}^{k}{(-1)^{i-1}e_{k-i}p_{i}} \qquad (n \ge k \ge 1)}$
...
$5e_{5} = e_{4}p_{1} - e_{3}p_{2} + e_{2}p_{3} - e_{1}p_{4} + e_{0}p_{5} = 0 = 0 * 1 - \dfrac{1}{6} * 2 + (-\dfrac{1}{2}) * 3 - 1 * \dfrac{25}{6} + 1 * p_{5} \implies p_{5}=\bbox[5px, border: 1px solid black]{6} = x^5 + y^5 + z^5$
...
2. $a=11 \implies b^2=900 \implies b=30 \implies 67b+a=\bbox[5px, border: 1px solid black]{2021}$
...
$\implies AD=AF-DF=7-5=\bbox[5px, border: 1px solid black]{2}$
...
$\implies height_E=height_H+2=15+2=\bbox[5px, border: 1px solid black]{17}$
...
Make $CF \perp DE \implies DF=EF \implies AD \parallel BE \implies \angle{A}=180^{\circ}-\angle{CBE}=\bbox[5px, border: 1px solid black]{105^{\circ}}$
...
$\implies \dfrac{1}{3}n-\dfrac{3}{5}=0 \implies n=\dfrac{9}{5} \implies AC=3+\dfrac{5}{3}n=\bbox[5px, border: 1px solid black]{6}$
...
$\triangle{AGB} \sim \triangle{ADC}, \triangle{ANG} \sim \triangle{AFD} \implies \dfrac{DF}{FC}=\dfrac{NG}{BN}=\bbox[5px, border: 1px solid black]{\dfrac{1}{2}}$
...
$\implies S_{\triangle{DEF}}= \dfrac{S_{\triangle{BDE}}+S_{\triangle{BDF}}}{2}=\dfrac{(\dfrac{7}{10}+\dfrac{7}{18})S_{\triangle{ABC}}}{4}=\bbox[5px, border: 1px solid black]{\dfrac{49\sqrt{3}}{5}}$
...
$\implies CD = \dfrac{2 * OC}{\sqrt{5} + 1} = \dfrac{2AC}{\sqrt{3}(\sqrt{5} + 1)} = \dfrac{2 * 6}{\sqrt{3}(\sqrt{5} + 1)} = \bbox[5px, border: 1px solid black]{\sqrt{15} - \sqrt{3}}$
...
$\displaystyle \lim_{d\to 0}{\dfrac{tan(d)-d}{d^3}}=\lim_{d\to 0}\dfrac{sec^2(d)-1}{3d^2}=\lim_{d\to 0}\dfrac{1-cos(d)}{3d^2} \cdot \dfrac{1+cos(d)}{cos^2(d)}=2\lim_{d\to 0}\dfrac{sin(d)}{6d}=\dfrac{2}{6}=\bbox[5px, border: 1px solid black]{\dfrac{1}{3}}$
...
$=\displaystyle \dfrac{1}{4} \Big( \lim_{t\to 0}{\dfrac{\dfrac{tan(t)}{1-tan^2(t)}-tan(t)}{t^3}} + K \Big)=\dfrac{1}{4} \Big( \lim_{t\to 0}{\dfrac{tan^3(t)}{t^3}} + K \Big)=\dfrac{1}{4} \Big(1+K \Big)\implies K=\bbox[5px, border: 1px solid black]{\dfrac{1}{3}}$
