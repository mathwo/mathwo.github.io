...
\shoveleft \implies \angle{ABC} = \dfrac{\angle{AEC}}{2}=\bbox[5px, border: 1px solid black]{30^{\circ}}
\end{multline}
$$
...
\shoveleft \implies \angle{CAD}=\dfrac{\angle{CFD}}{2}=\dfrac{60^{\circ}}{2}=\bbox[5px, border: 1px solid black]{30^{\circ}}
\end{multline}
$$
...
\shoveleft \implies \angle{BDC}=\angle{BD'C}=\angle{CBD'}=\angle{CBD}=\bbox[5px, border: 1px solid black]{10^{\circ}}
\end{multline}
$$
