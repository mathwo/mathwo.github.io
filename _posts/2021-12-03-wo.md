...
$r_A=3, r_B=4, r_C=2 \implies r_D=\bbox[5px, border: 1px solid black]{12}$
...
![image-20211220001457926](/assets/images/2021/image-20211220001457926.png)

**Solve:**

Connect $EF$:

![image-20211220001151105](/assets/images/2021/image-20211220001151105.png)
...
$\implies \angle{BAE}=\angle{CAE} \implies \angle{BAD}=\dfrac{\angle{CAD}}{3}=\dfrac{39^{\circ}}{3}=\bbox[5px, border: 1px solid black]{13^{\circ}}$
