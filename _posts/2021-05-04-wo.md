...
![image-20210530011839159](/assets/images/2021/image-20210529013250615.png)
...
\shoveleft \text{Find } F \text{so that } BE=BF=CE=DE, \angle{FBE}=108^{\circ}, \text{ connect } AF, CF, DF, EF$. \text{ So we know that}\\
\shoveleft \angle{FBC}=108^{\circ}-36^{\circ}=72^{\circ}\\
\shoveleft \triangle{BCE} \cong \triangle{BEF} \implies EF=BC=AB, \angle{BFE}=\angle{BEF}=36^{\circ}=\angle{BCE}=\angle{EBC}\\
\shoveleft \implies \angle{DEF}=36^{\circ}-24^{\circ}=12^{\circ}\\
\shoveleft \angle{ABF}=108^{\circ}-78^{\circ}-18^{\circ}=12^{\circ}=\angle{DEF}\\
