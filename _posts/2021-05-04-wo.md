...
#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=30^{\circ}$, $\angle{CBD}=40^{\circ}$, $\angle{BCD}=20^{\circ}$, $\angle{ACD}=50^{\circ}$, find $\angle{CAD}$.

![image-20210504024839436](/assets/images/2021/image-20210504024839436.png){:class="image--x2l"}

**Solute:**

![image-20210504031704368](/assets/images/2021/image-20210504031704368.png){:class="image--x2l"}
...
$\implies \angle{DAC}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

---

### 05/05/2021

#### $P$ is a point inside $\triangle{ABC}$ such that $\angle{ABP}=20^{\circ}$, $\angle{CBP}=40^{\circ}$, $\angle{BCP}=30^{\circ}$, $\angle{ACP}=10^{\circ}$, find $\angle{BAP}$.
...
$\implies \triangle{ABP} \cong \triangle{DBG} \implies \angle{BAP}=\angle{BPF}=90^{\circ}-\angle{DBF}=\bbox[5px, border: 1px solid black]{50^{\circ}}$

---

### 05/06/2021

#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=\angle{CBD}=\angle{ACD}10^{\circ}$, $\angle{BCD}=20^{\circ}$, find $\angle{CAD}$.

![image-20210504040852149](/assets/images/2021/image-20210504040852149.png){:class="image--x6l"}

**Solve 1:**

![image-20210504042354609](/assets/images/2021/image-20210504042354609.png){:class="image--x6l"}
...
$\implies \angle{AED}=20^{\circ} \implies \angle{EAD}=80^{\circ} \implies \angle{DAC}=80^{\circ}-50^{\circ}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

**Solve 2:**

![image-20250705211751500](/assets/images/2021/image-20250705210737988.png)
$$
\begin{multline}
...
#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=\angle{CBD}=\angle{BCD}=10^{\circ}$, $\angle{ACD}=20^{\circ}$, find $\angle{CAD}$.
...
$\implies \triangle{BDE}$ is equilateral $\implies DE=BE=EA \implies \angle{EAD}=80^{\circ} \implies \angle{DAC}=\bbox[5px, border: 1px solid black]{100^{\circ}}$

---

### 05/08/2021

#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=20^{\circ}$, $\angle{CBD}=30^{\circ}$, $\angle{BCD}=30^{\circ}$, $\angle{ACP}=10^{\circ}$, extend $CD, BD$ and meet $AB, AC$ at $E, F$ respectively, find $\angle{EFD}$.
...
$\implies GH=EH=FH \implies \angle{EFD}=\angle{EHD}=\bbox[5px, border: 1px solid black]{40^{\circ}}$

---

### 05/09/2021

#### $D, E$ are points on side $AC, BC$ of $\triangle{ABC}$ respectively such that $\angle{CAE}=10^{\circ}$, $\angle{BAE}=70^{\circ}$, $\angle{CBD}=20^{\circ}$, $\angle{ABD}=60^{\circ}$, find $\angle{DEA}$.

![image-20210525215027219](/assets/images/2021/image-20210525214721068.png)
...
![image-20220721004554396](/assets/images/2021/image-20220721004554396.png)
...
#### $D, E$ are points on side $AC, BC$ of $\triangle{ABC}$ respectively such that $\angle{CAE}=20^{\circ}$, $\angle{BAE}=60^{\circ}$, $\angle{CBD}=30^{\circ}$, $\angle{ABD}=50^{\circ}$, find $\angle{DEA}$.
...
$\implies \angle{DEA}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

**Solve 2:**

![image-20211227210243327](/assets/images/2021/image-20211227205333540.png)
...
$\implies \angle{DEF}=\angle{DEG}=\dfrac{\angle{FEG}}{2}=\dfrac{60^{\circ}}{2}=\bbox[5px, border: 1px solid black]{30^{\circ}}$
...
$\implies \angle{DEA}=180^{\circ}-\angle{DAE}-\angle{ADB}-\angle{FDG}-\angle{EDF}=180^{\circ}-20^{\circ}-50^{\circ}-30^{\circ}-50^{\circ}=\bbox[5px, border: 1px solid black]{30^{\circ}}$
...
$\implies tan x = \dfrac{1}{\sqrt{3}} \implies x=\angle{AED}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

**Solve 5:**

![image-20211227232651318](/assets/images/2021/image-20211227232651318.png)
...
$=\dfrac{\dfrac{1}{2}sin(40^{\circ})}{sin(40^{\circ})cos(30^{\circ})+cos(40^{\circ})sin(30^{\circ})-sin(30^{\circ})cos(40^{\circ})}=\dfrac{\dfrac{1}{2}sin(40^{\circ})}{cos(30^{\circ})sin(40^{\circ})}=\dfrac{1}{\sqrt{3}}\implies \angle{f}=\bbox[5px, border: 1px solid black]{30^{\circ}}$
...
#### $C$ is a point inside $\triangle{ABD}$ such that $\angle{CAD}=20^{\circ}$, $\angle{BAC}=60^{\circ}$, $\angle{CDA}=10^{\circ}$, $AB=AD$, find $\angle{ACB}$.
...
$\implies F, C, B$ is collinear $\implies \angle{ACB}=180^{\circ}-80^{\circ}=\bbox[5px, border: 1px solid black]{100^{\circ}}$

---

### 05/12/2021

#### $D$ is a point on side $AB$ of $\triangle{ABC}$ such that $\angle{CAB}=80^{\circ}$, $\angle{ABC}=20^{\circ}$, $AC=BD$, find $\angle{ADC}$.
...
$\implies \angle{ADC}=\angle{DCB}+\angle{CBA}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

---

### 05/13/2021

#### $E$ is a point on altitude $AD$ of $\triangle{ABC}$ such that $AD \perp BC$, $D \in BC$,  $\angle{ABE}=\angle{CBE}=10^{\circ}$, $\angle{CAD}=40^{\circ}$, find $\angle{ECD}$.

![image-20210526224522213](/assets/images/2021/image-20210526224522213.png)

**Solve 1:**

![image-20210528004548638](/assets/images/2021/image-20210528004548638.png)
...
$\implies AJ=AC \implies JD=CD \implies \angle{ECD}=\angle{EJD}=\angle{KFM}=\bbox[5px, border: 1px solid black]{30^{\circ}}$

**Solve 2:**

![image-20210528014801441](/assets/images/2021/image-20210528014801441.png){:class="image--x9l"}

![image-20210528022607511](/assets/images/2021/image-20210528022607511.png)
...
$\implies \angle{CGF}=\dfrac{180^{\circ}-100^{\circ}}{2}=40^{\circ} \implies \angle{FEC}=40^{\circ} \implies \angle{ECD}=90^{\circ}-20^{\circ}-40^{\circ}=\bbox[5px, border: 1px solid black]{30^{\circ}}$
...
![image-20250910233122705](/assets/images/2021/image-20250910233122705.png)
$$
\begin{multline}
...
#### $D$ is a point on side $AC$ $\triangle{ABC}$ such that $AB=CD$, $\angle{BAC}=40^{\circ}$, $\angle{ACB}=30^{\circ}$, find $\angle{CBD}$.
...
$\implies \angle{CBD}=\angle{CBO}=\bbox[5px, border: 1px solid black]{50^{\circ}}$

---

### 05/15/2021

#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=40^{\circ}$, $\angle{CBD}=20^{\circ}$, $\angle{ACD}=\angle{BCD}=20^{\circ}$, find $\angle{BAD}$.
...
$\implies BE=BD \implies AB=BD \implies \angle{BAD}=\dfrac{180^{\circ}-40^{\circ}}{2}=\bbox[5px, border: 1px solid black]{70^{\circ}}$

---

### 05/16/2021

#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=30^{\circ}$, $\angle{CBD}=\angle{ACD}=\angle{BCD}=10^{\circ}$, find $\angle{BAD}$.
...
#### $D$ is a point inside $\triangle{ABC}$ such that $\angle{ABD}=18^{\circ}$, $\angle{CBD}=42^{\circ}$, $\angle{BCD}=12^{\circ}$, $\angle{ACD}=48^{\circ}$, find $\angleDAC}$.

![image-20210529150055416](/assets/images/2021/image-20210529145705215.png)

**Solve:**

![image-20220416012210824](/assets/images/2021/image-20220416011606378.png)
...
\shoveleft \angle{BFE}=\angle{BCE} \implies BECF \text{ are cyclic}\\
...
\shoveleft \implies \angle{DAC}=\angle{BAC}-\angle{BAD}=60^{\circ}-6^{\circ}=\bbox[5px, border: 1px solid black]{54^{\circ}}\\
\end{multline}
$$
