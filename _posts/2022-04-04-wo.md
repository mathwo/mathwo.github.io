...
\shoveleft \implies  \angle{ADC}=\dfrac{\angle{FDG}}{2}=\bbox[5px, border: 1px solid black]{18^{\circ}} \nonumber
\end{multline}
$$
...
\shoveleft \text{So we know }\bbox[5px, border: 1px solid black]{x=1, y=2} \nonumber
\end{multline}
$$
...
\shoveleft \implies x=\bbox[5px, border: 1px solid black]{30^{\circ}}
\end{multline}
$$
...
\shoveleft \implies \angle{BAD}=\angle{AFE}=\bbox[5px, border: 1px solid black]{30^{\circ}}
\end{multline}
$$
...
\shoveleft \implies x=\bbox[5px, border: 1px solid black]{15^{\circ}} \text{ or } x=\bbox[5px, border: 1px solid black]{35^{\circ}} \nonumber
\end{multline}
$$
