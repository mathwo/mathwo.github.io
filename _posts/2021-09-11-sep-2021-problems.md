...
#### $OC=1$, randomly pick points $A,B$ on $OC$, what is the possibility that OA, AB, BC can be three sides of a triangle?

**Solve:**

![image-20210919022350261](/assets/images/2021-09/image-20210919022350261.png)

Let the length of three sides are $x, y, z$, the equation $x+y+z=1$ and $x>0, y>0, z>0$ forms the area of $\triangle{XYZ}$ with $OX=OY=OZ=1$
