...
$$
\begin{multline}
\shoveleft \text{In Barycentric Coordinate system, we have the coordinates for points }H, I \text{ and } M \text{as:}\\
\shoveleft M=(0 : \dfrac{1}{2} : \dfrac{1}{2}), I=(a : b : c), H=(tanA : tanB : tanC)\\
\shoveleft \text{Now we calculate and normalize them:}\\
\shoveleft a=14, b=15, c=13 \implies s=\dfrac{a+b+c}{2}=21\\
\shoveleft S_{\triangle{AVC}}=\sqrt{s(s-a)(s-b)(s-c)}=\sqrt{21 \times 8 \times 7 \times 6}=84\\
\shoveleft \text{Here we can get } sinA, sinB, sinC \text{ from }\\
\shoveleft S_{\triangle{ABC}}=\dfrac{1}{2}bcsinA=\dfrac{1}{2}acsinB=\dfrac{1}{2}absinC\\
\shoveleft \text{Then get } tanA, tanB, tanC \text{ from } sinA, sinB, sinC. \text{ Alternatively, we can use following approach:}\\
\shoveleft a^2+b^2-c^2=14^2+15^2-13^2=252\\
\shoveleft b^2+c^2-a^2=15^2+13^2-14^2=198\\
\shoveleft c^2+a^2-b^2=13^2+14^2-15^2=140\\
\shoveleft
\end{multline}
$$
...
$$
\begin{multline}
\shoveleft \text{Then we know (three points in counter-clock wise order)}\\
\end{multline}
$$
...
\end{vmatrix}=\dfrac{13 \times 5}{2 \times 16 \times 42} + \dfrac{99}{6 \times 224}-\dfrac{5 \times 5}{2 \times 14 \times 16}-\dfrac{55}{2 \times 3 \times 224}\\&=\dfrac{34}{6 \times 224} \implies S_{\triangle{HIM}}=84 \times \dfrac{34}{6 \times 224}=\bbox[5px, border: 1px solid black]{\dfrac{17}{8}}
\end{align*}
$$
...
#### Let $A=\frac{2}{3} \cdot \frac{5}{6} \cdot \frac{8}{9} \cdots \cdot \frac{995}{996} \cdot \frac{998}{999}$. Which is bigger, $A$ or $0.1?$
...
$\dfrac{1}{4} \cdot \dfrac{1}{4} \cdot 2 \cdot 4 + \dfrac{1}{32} \cdot 4 + \dfrac{5}{64} \cdot \dfrac{1}{4} \cdot 2 \cdot 4 = \bbox[5px, border: 1px solid black]{\dfrac{25}{32}}$
...
=\dfrac{1}{2} + \dfrac{1}{8} + \dfrac{5}{32} = \bbox[5px, border: 1px solid black]{\dfrac{25}{32}}
\end{align*}
$$
...
So it's easy to know that $f(2001)=\dfrac{2001 \times 2002}{2}=\bbox[5px, border: 1px solid black]{2003001}$

**Solution 2:**

We have $f(n+1)=f(n)+f(1)+n \implies f(n+1)-f(n)=n+f(1) $

$\implies f(2001)-f(0)=\displaystyle\sum_{i=0}^{2000}{i} + 2001f(1) \implies f(2001)=\dfrac{2000 \times 2001}{2} + 2001 = \dfrac{2001 \times 2002}{2}=\bbox[5px, border: 1px solid black]{2003001}$
...
So the volume of $EFE'F'GG'$ is $2 \times \dfrac{GG'}{2} \times \dfrac{1}{3} \times S_{EFE'F'}=\dfrac{1}{2} \times \dfrac{1}{3}=\bbox[5px, border: 1px solid black]{\dfrac{1}{6}}$.
...
* $m + n = 12 \implies a+b=24, ab=44 \text{ or } 80 \text{ or } 108 \text{ or } 128 \text{ or } 140$
  ...
  $\implies a+b+c=\bbox[5px, border: 1px solid black]{35}$
...
$S_{GIHJ}=GJ \times HI \times \dfrac{1}{2}=\dfrac{1}{2} \times \dfrac{6}{11} \times \dfrac{1}{2}=\bbox[5px, border: 1px solid black]{\dfrac{3}{22}}$
...
So the answer is $BE=x=\dfrac{b+c}{2}=\bbox[5px, border: 1px solid black]{4}$

**Solve 2:**

![image-20210228203236848](/assets/images/2021/image-20210228203236848.png){:class="image--lg"}

Rotate $\triangle{BCE}$ by $90^{\circ}$ anti-clockwise, so the area of $ABCD$ is 16 and it forms a square with side $BE$. So $BE=\bbox[5px, border: 1px solid black]{4}$.
...
6. Since $BE$ is tangent to the circle, we know that $\angle{FBE}=\angle{FAB}=30^{\circ}+44^{\circ}=74^{\circ} \implies \angle{HBE}=74^{\circ}-33^{\circ}=\bbox[5px, border: 1px solid black]{41^{\circ}}$
