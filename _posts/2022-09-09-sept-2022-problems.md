...
<img src="C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20220930161037976.png" alt="image-20220930161037976" style="zoom:50%;" />
$$
\cfrac{AC}{CE}=\cfrac{AB}{BE}, \cfrac{AF}{DF}=\cfrac{AB}{BD} \implies \cfrac{AC \cdot BE}{CE}=\cfrac{AF \cdot BD}{DF}\\
\cfrac{AF}{AE}=\cfrac{AD}{AC}=\cfrac{DF}{CE}=\dfrac{AF \cdot BD}{AC \cdot BE} \implies \cfrac{AC}{AE}=\cfrac{BD}{BE}\\
\cfrac{BE}{BF}=\cfrac{BD}{BC}=\cfrac{DE}{CF} \implies \cfrac{BE}{DE}=\cfrac{BF}{CF}\\
\cfrac{CF}{AF}\cfrac{AD}{DE}\cfrac{BE}{BC}=1, AD=BC \implies \cfrac{BE}{DE}=\cfrac{AF}{CF}\\
\implies \text{we need prove: } \cfrac{AF}{CF}=\cfrac{BF}{CF} \implies AF=BF\\
$$
