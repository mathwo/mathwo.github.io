...
$$
\begin{align*}
{O_x}&=\dfrac{(A_x^2+A_y^2)(B_y-C_y)+(B_x^2+B_y^2)(C_y-A_y)+(C_x^2+C_y^2)(A_y-B_y)}{2[A_x(B_y-C_y)+B_x(C_y-A_y)+C_x(A_y-B_y)]}
=\dfrac{\begin{vmatrix}A_x^2+A_y^2 & A_y & 1\\ B_x^2+B_y^2 & B_y & 1\\ C_x^2+C_y^2 & C_y & 1\end{vmatrix}}{2\begin{vmatrix}A_x & A_y & 1 \\ B_x & B_y & 1 \\ C_x & C_y & 1\end{vmatrix}} \\ &=\dfrac{a^3+a^2b+a^2c-ab^2+ac^2-b^3+b^2c-bc^2+c^3}{2a(a+b+c)} \\
{O_y}&=\dfrac{(A_x^2+A_y^2)(C_x-B_x)+(B_x^2+B_y^2)(A_x-C_x)+(C_x^2+C_y^2)(B_x-A_x)}{2[A_x(B_y-C_y)+B_x(C_y-A_y)+C_x(A_y-B_y)]}
=\dfrac{\begin{vmatrix}A_x & A_x^2+A_y^2 & 1\\ B_x & B_x^2+B_y^2 & 1\\ C_x & C_x^2+C_y^2 & 1\end{vmatrix}}{2\begin{vmatrix}A_x & A_y & 1 \\ B_x & B_y & 1 \\ C_x & C_y & 1\end{vmatrix}} \\ &=-\dfrac{(a-b+c)(a+b-c)(a^2-b^2-c^2)}{8aS}
\end{align*}
$$
