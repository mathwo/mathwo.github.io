...
So the answer is $3 \times 128 + 6 \times 256 + 384=\bbox[5px, border: 1px solid black]{2304}$
...
\end{bmatrix}
\end{equation*}
=\bbox[5px, border: 1px solid black]{2304}
\text{.}
$$
...
$\implies b=a+2=4041 \implies (a+b)_{min}=\bbox[5px, border: 1px solid black]{8080}$

---

### 12/05/2020

#### If $\frac{1}{6}=\frac{1}{a_1}+\frac{1}{a_2}+\frac{1}{a_3}+\frac{1}{a_4}+\frac{1}{a_5}+\frac{1}{a_6}$ and $a_i \in \mathbb{N}$, $\forall i \ne j, a_i \ne a_j$. What is the smallest possible value of $\displaystyle \sum_{i=1}^{6}a_i.$
...
$x=\bbox[5px, border: 1px solid black]{-1, \dfrac{1\pm \sqrt{5}}{2}}$
...
So the solution is $x=\bbox[5px, border: 1px solid black]{3}$
...
$ \implies BC=\bbox[5px, border: 1px solid black]{150\sqrt{7}}$
...
When $p=0.5$, the answer is $\bbox[5px, border: 1px solid black]{25}$.
...
$ \implies AD=\sqrt{AB^2+BC^2-CD^2}=\bbox[5px, border: 1px solid black]{\sqrt{21}}$
...
* if $a-b=1$, $(1) \implies 8a=2024 \implies a=\bbox[5px, border: 1px solid black]{253}$
...
So the sum of all possible values of $n$ is $\bbox[5px, border: 1px solid black]{255}$.
...
So there are totally $15+70+70+15=\bbox[5px, border: 1px solid black]{170}$ different ways.
...
Thus totally the probability that the grid is entirely black: $\dfrac{1}{2} \times \dfrac{7}{16} \times \dfrac{7}{16} = \bbox[5px, border: 1px solid black]{\dfrac{49}{512}}$
...
So the answer is $\dfrac{1}{1+\dfrac{499}{50}} \approx \dfrac{50}{550} = \bbox[5px, border: 1px solid black]{\dfrac{1}{11}}$
