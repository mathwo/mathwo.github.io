...
##### Trapezoid $ABCD$ has $\angle{ABC}=\angle{BAD}=90^{\circ}, BC=12, AD=14$. Point $E, F$ are on side $AB, CD$ respectively. Point $C, E$ is tangent to circle.  $EF \perp CD$ at $F$. Find $EF$
