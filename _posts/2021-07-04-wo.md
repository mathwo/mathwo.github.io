...
\shoveleft \implies sin(2x)=\dfrac{1}{2}\implies 2x=30^{\circ} \implies x=\bbox[5px, border: 1px solid black]{15^{\circ}}\\
\end{multline}
$$
...
$$
\begin{multline}
\shoveleft \text{From }\href{https://www.cut-the-knot.org/triangle/TrigCeva.shtml}{\text{Trigonometric Form of Ceva's Theorem}}\\
\shoveleft \dfrac{sin(45^{\circ}-x)}{sinx}\dfrac{sin(45^{\circ}-x)}{sinx}\dfrac{sinx}{sin(90^{\circ}-x)}=1\\
\shoveleft \implies sin^2(45^{\circ}-x)=sinx*cosx\\
\shoveleft \implies (sin45^{\circ}cosx-cos45^{\circ}sinx)^2=sinx*cosx\\
\shoveleft \implies 4sinx*cosx=1 \implies sin(2x)=\dfrac{1}{2} \implies 2x=30^{\circ}\implies x=\bbox[5px, border: 1px solid black]{15^{\circ}}\\
\end{multline}
$$
...
\shoveleft \implies OC\perp BC \implies \angle{BCD}=90^{\circ}-\angle{MCD}=\bbox[5px, border: 1px solid black]{15^{\circ}}\\
\end{multline}
$$
