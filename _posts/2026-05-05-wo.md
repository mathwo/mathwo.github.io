...
![image-20260517061150072](/assets/images/2026/image-20260517060655088.png)
$$
\begin{multline}
...
2. The circle $(BDM)$ inverts $A$ into $C$
3. Any two of the following conditions implies the third condition (illustrated in EGMO by Evan Chen):
...
![image-20260522220906858](/assets/images/2026/image-20260522220906858.png)

**Solve 1:**

![image-20260522215028188](/assets/images/2026/image-20260522215028188.png)
$$
\begin{multline}
...
![image-20260524015130396](/assets/images/2026/image-20260524015038451.png)

**Solve:**

![image-20260524015719833](/assets/images/2026/image-20260524015719833.png)
$$
\begin{multline}
...
#### $D$ is a point on side $BC$ of $\triangle{ABC}$ such that $\angle{ACB}=30^{\circ}$, $\angle{DAC}=10^{\circ}$, $\angle{BAD}=40^{\circ}$, prove that $AD=BC$

![image-20260531140551216](/assets/images/2026/image-20260531140551216.png)

**Prove:**

![image-20260531140515524](/assets/images/2026/image-20260531135734621.png)
$$
\begin{multline}
\shoveleft \text{Easy to see }\angle{ABC}=100^{\circ}, \angle{ADB}=40^{\circ}=\angle{BAD}\implies AB=BD\\
\shoveleft \text{Make equilateral triangle }\triangle{BCE} \text{ such that }E \text{ is on the other side of }AC \text{ to }B\\
\shoveleft \implies \angle{EBC}=\angle{ACB}=60^{\circ}\implies \angle{ACB}=30^{\circ} \implies \triangle{ABC}\cong\triangle{AEC}\\
\shoveleft \implies AB=AE=BD, \angle{BAC}=\angle{EAC} \implies \angle{BAE}=100^{\circ}=\angle{ABD}\\
\shoveleft \implies \triangle{BAE}\cong\triangle{ABD}\implies AD=BE=BC\blacksquare
\end{multline}
$$
