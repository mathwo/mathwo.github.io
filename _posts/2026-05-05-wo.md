...
$$
\begin{multline}
\shoveleft \text{易知}\triangle{ABE}\sim \triangle{DCE}, \text{令}BE=3a,AE=3b \implies CE=4a,DE=4b \implies BC=5a\\
\shoveleft \text{令}AF\text{为圆直径} \implies \angle{ACB}=\angle{AFB}\implies sin\angle{ACB}=\dfrac{3}{5}=sin\angle{AFB}=\dfrac{6}{2R}\implies R=\bbox[5px, border: 1px solid black]{5}
\end{multline}
$$
**Solve 2:**
$$
