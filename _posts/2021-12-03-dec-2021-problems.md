...
![image-20211218231810172](/assets/images/2021-12/image-20211218231810172.png)

**Prove:**

Extend $BD$ so it and $AE$ intersect at $F$. Extend $AE$ to $G$ so that $CG \perp AG$.

![image-20211218231701102](/assets/images/2021-12/image-20211218231701102.png)
...
![image-20211228020137657](/assets/images/2021-12/image-20211228020137657.png)

---

### 12/29/2021

![image-20211229021602201](/assets/images/2021-12/image-20211229021602201.png)

**Solve:**

![image-20211230104733907](/assets/images/2021-12/image-20211230104733907.png)
...
$\implies \angle{BAE}=\angle{CAE} \implies \angle{BAD}=\dfrac{\angle{CAD}}{3}=\dfrac{39^{\circ}}{3}=\boxed{13^{\circ}}$
