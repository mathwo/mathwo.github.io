...
$\implies \dfrac{A'B}{A'C}=\dfrac{A'C}{A'D}\implies \triangle{A'BC} \sim \triangle{A'CD} \implies \angle{A'BC}=\angle{A'CD}=30^{\circ} \implies \angle{BCD}=54^{\circ}-30^{\circ}=\bbox[15px, border: 1px solid black]{24^{\circ}} $
...
$\implies \angle{BCD}=60^{\circ}-30^{\circ}-6^{\circ}=\bbox[15px, border: 1px solid black]{24^{\circ}}$
