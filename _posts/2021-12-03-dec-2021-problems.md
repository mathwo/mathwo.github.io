...
$\implies \dfrac{A'B}{A'C}=\dfrac{A'C}{A'D}\implies \triangle{A'BC} \sim \triangle{A'CD} \implies \triangle{A'BC}=\angle{A'CD}=30^{\circ} \implies \angle{BCD}=54^{\circ}-30^{\circ}=\boxed{24^{\circ}} $
