...
Check $\triangle{AEF}, \angle{AFE}=30^{\circ}, AE=DE=DF \implies EF=2AE$, apple the Law of Sines we know $\dfrac{sin\angle{EAF}}{sin\angle{AFE}}=\dfrac{EF}{AE}=2 \implies sin\angle{EAF}=2sin\angle30^{\circ}=1 \implies \angle{EAF}=90^{\circ}\implies AD=DF \implies \angle{BAD}=\angle{AFE}=\boxed{30^{\circ}}$
