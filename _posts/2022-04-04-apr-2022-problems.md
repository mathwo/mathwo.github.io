...
$\dfrac{sin\angle{EAF}}{sin\angle{AFE}}=\dfrac{EF}{AE}=2 \\ \implies sin\angle{EAF}=2sin\angle30^{\circ}=1 \\ \implies \angle{EAF}=90^{\circ}\implies AD=DF \\ \implies \angle{BAD}=\angle{AFE}=\boxed{30^{\circ}}$
