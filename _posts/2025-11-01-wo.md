...
#### Let $A=\frac{1}{2}+\frac{1}{3}+\frac{1}{4}+\cdots+\frac{1}{308}+\frac{1}{309}$ and $B=\frac{308}{1}+\frac{307}{2}+\frac{306}{3}+\cdots+\frac{3}{306}+\frac{2}{307}+\frac{1}{308}$, find $\frac{A}{B}$

**solve:**
$$
\begin{multline}
\shoveleft B+308=309(\frac{1}{1}+\dfrac{1}{2}+...+\frac{1}{308}) \implies B=309\sum_{i=1}^{308}{\frac{1}{i}}-308\\
\shoveleft A=\sum_{i=1}^{308}{\frac{1}{i}}-1+\frac{1}{309}=\sum_{i=1}^{308}{\frac{1}{i}}-\dfrac{308}{309} \implies \dfrac{A}{B}=\bbox[5px, border: 1px solid black]{\dfrac{1}{309}}\\
\shoveleft
\end{multline}
$$
...
![image-20251118225449743](/assets/images/2025/image-20251118224739990.png)

**Solve:**

![image-20251118230658557](/assets/images/2025/image-20251118230658557.png)
$$
\begin{multline}
