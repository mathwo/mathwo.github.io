...
![image-20210730022114177](E:\workspace\mwo\assets\images\2021-07\image-20210730022114177.png)
...
$\implies sin(\angle{MFN}) \cdot sin(30^{\circ}-\angle{MFN})=sin12^{\circ} \cdot sin(18^{\circ})$

The rest will be the same as solution 1.
