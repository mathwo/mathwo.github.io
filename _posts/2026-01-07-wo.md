...
![image-20260124135613779](H:\workspace\mwo\assets\images\2026\image-20260124135613779.png)

**Prove:**

![image-20260124140050708](H:\workspace\mwo\assets\images\2026\image-20260124140050708.png)
$$
\begin{multline}
...
- Let $G=CI \cap [DEF], H=AI \cap [DEF], K=BI \cap [DEF]$, then simply angle chasing will give $GE=GF=GI, HD=HF=HI, KD=KE=KI$ which is [The Incenter/Excenter Lemma](https://web.evanchen.cc/handouts/Fact5/Fact5.pdf)
- Since $CD\perp AB, BF \perp CA, AE \perp BC$ simple angle chasing will give $\angle{HAD}=\angle{HDA}$, $\angle{FAH}=\angle{AFH}$ etc., which implies $CG=FG=EG=IG, AH=DH=FH=IH, BK=DK=EK=IK$, so $G, H, K$ are the circumcenters of  $\triangle{CEF}, \triangle{ADF}, \triangle{BDE}$ respectively -- this conclusion seems not mentioned before somehow.

![image-20260124141819728](H:\workspace\mwo\assets\images\2026\image-20260124141819728.png)
