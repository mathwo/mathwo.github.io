...
- Let $G=CI \cap [DEF], H=AI \cap [DEF], K=BI \cap [DEF]$, then simply angle chasing will give $GE=GF=GI=GC, HD=HF=HI=HA, KD=KE=KI=KB$, which means that $A=E\text{-excenter}=I_E, B=F\text{-excenter}=I_F, C=D\text{-excenter}=I_D$ , and this is [The Incenter/Excenter Lemma](https://web.evanchen.cc/handouts/Fact5/Fact5.pdf)
