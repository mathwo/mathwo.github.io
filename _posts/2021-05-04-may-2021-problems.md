...
$sin(e)=sin(180^{\circ}-(a+b+c+d+f))=sin(a+b+c+d+f)=sin(a+b+c+d)cos(f)+cos(a+b+c+d)sin(f) $

$\implies sin(a)sin(c)sin(a+b+c+d+f)=sin(a)sin(c)sin(a+b+c+d)cos(f)+sin(a)sin(c)cos(a+b+c+d)sin(f)=sin(b)sin(d)sin(f)$
