...
\shoveleft \implies \angle{ABC}=\angle{BFC}=\angle{DFG}=\angle{EFG} \\
...
\shoveleft \implies n^2+c^2=\dfrac{\dfrac{n^2+c^2}{n^2}x^2}{m^2}x^2 \implies x=mn=\bbox[5px, border: 1px solid black]{36}
\end{multline}
$$
