...
##### (Gauss-Bodenmiller Theorem) Four lines intersect at six points $A,B,C,D,E,F$ and $G,H,M$ is the midpoint of diagonal $EF, AC, BD$ respectively. Show that $G,H,M$ are collinear. (Line $GHM$ is called Newton-Gauss Line)
...
- A.E. Layng Euclid's Elemens of Geometry: books I. II. III. IV., VI and Portions of books V. and XI., with notes, examples, exercises, appendices and a collection of examination papers, [Page 284](https://ia601602.us.archive.org/20/items/layngeuclid00euclrich/layngeuclid00euclrich.pdf)
