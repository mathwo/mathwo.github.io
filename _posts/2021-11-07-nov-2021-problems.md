...
### 11/07/2021
 ...
 3. [Primorial](https://mathworld.wolfram.com/Primorial.html) related to the corollary: $e = \displaystyle \lim _{n \to \infty}{(\prod_{k=1}^{\pi(n)}{p_k})^{1/n}} = \lim _{n \to \infty}{(\prod_{k=1}^{\pi(n)}{p_k})^{1/p_n}}$
...
![image-20211112045957591](E:\workspace\mwo\assets\images\2021-11\image-20211112045957591.png)

**Solve:**

![image-20211112050158879](E:\workspace\mwo\assets\images\2021-11\image-20211112045817464.png)
