...
$\displaystyle =\dfrac{1}{2\sqrt{2}} tan^{-1}\large ( \dfrac{x-\dfrac{1}{x}}{\sqrt{2}} \large )-\dfrac{1}{4\sqrt{2}}ln \left\lvert \dfrac{x+\dfrac{1}{x}-\sqrt{2}}{x+\dfrac{1}{x}+\sqrt{2}} \right\lvert + C$

$\displaystyle =\boxed{\dfrac{1}{4\sqrt{2}}\large[2 tan^{-1}\large( \dfrac{x^2-1}{\sqrt{2}x} \large) +ln \left\lvert \dfrac{x^2+\sqrt{2}x+1}{x^2-\sqrt{2}x+1} \right\lvert \large] + C}$
