...
Let $F$ be the mirror point of $C$ along $AE$. Connect $AF, EF, CF, DF$.

![image-20211120022945468](/assets/images/2021-11/image-20211120022106717.png)

$AB=AC=BC=AF, \angle{BAF}=60^{\circ}+2*(60^{\circ}-42^{\circ})=92^{\circ} \implies \angle{FBA}=\angle{AFB}=42^{\circ} \implies \angle{DBC}=18^{\circ} \implies \text{ABCD are cyclic}$

$\implies \angle{BCD}=\angle{BAC}=60^{\circ}\implies \angle{CDE}=60^{\circ} \implies \text{CD bisects } \angle{BDE}$

$AC=AF=6, \angle{ACF}=36^{\circ} \implies CF=\dfrac{2AC}{\sqrt{5}+1} \implies CD=\dfrac{2*6}{\sqrt{3}(\sqrt{5}+1)}=\boxed{\sqrt{15}-\sqrt{3}}$
