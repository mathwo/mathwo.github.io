...
![image-20211115065506652](E:\workspace\mwo\assets\images\2021-11\image-20211115065506652.png)

**Solve:**

![image-20211115063317545](E:\workspace\mwo\assets\images\2021-11\image-20211115062614330.png)
...
$EG^2+AE^2=AG^2 \implies m^2+\dfrac{4}{9}n=4 \implies \left( \dfrac{2}{5}+\dfrac{2}{3}n \right) ^2+\dfrac{4}{9}n=4 \implies \dfrac{1}{9}n^2+\dfrac{1}{15}n-\dfrac{12}{15}=0 \implies \left(\dfrac{1}{3}n-\dfrac{3}{5}\right) \left(\dfrac{1}{3}n+\dfrac{4}{5} \right)=0$
