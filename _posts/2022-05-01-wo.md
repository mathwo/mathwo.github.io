...
Area of the green triangle is half of the square, and is half of the rectangle. So the area of the rectangle is $\bbox[5px, border: 1px solid black]{16}$.
...
Make the height of the triangle as following, easy to know two green triangle is congruent to each other, so the height is also $4$. Then the triangle area is $\bbox[5px, border: 1px solid black]{8}$.
...
\shoveleft \implies f(n)=\dfrac{1}{2} \text{ for } n=1,2,... \implies f(100)=\bbox[5px, border: 1px solid black]{\dfrac{1}{2}}
\end{multline}
$$
...
\shoveleft =\dfrac{2+m-2}{2m}=\bbox[5px, border: 1px solid black]{\dfrac{1}{2}}
\end{multline}
$$
...
So the possibility is $\dfrac{S_{\triangle{DEF}}}{S_{\triangle{ABC}}}=\bbox[5px, border: 1px solid black]{\dfrac{1}{4}}$
