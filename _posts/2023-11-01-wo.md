...
![image-20231220175346128](/assets/images/2023/image-20231123033744100.png)
$$
\begin{multline}\nonumber
...
![image-20231220184528874](/assets/images/2023/image-20231220182510993.png)
$$
  \begin{multline}
...
![image-20231220185152321](/assets/images/2023/image-20231220185152321.png)
...
- $\odot{O_1}$ is tangent to $\odot{O}$ at $M$ and is tangent to secant $AB$ of $\odot{O}$ at $P$, $C$ is the midpoint of arc $\overset{\huge\frown}{AB}$ not containing $M$, $\odot{C}$ is the circle passing through $A$ and $B$ with center $C$ and radius $CA$. Let $\odot{C}$ intersect $\odot{O_1}$ at $X$ and $Y$ and intersect $MP$ at $I$, then $MX$ and $MY$ are tangent to $\odot{O_1}$, and $I$ is the incenter of $\triangle{MAB}$.
  ...
  ![image-20231220190211012](/assets/images/2023/image-20231220190211012.png)
  $$
  \begin{multline}
  \shoveleft \text{We already know }\angle{AMI}=\angle{IMB}\\
  \shoveleft \angle{CAI}=\angle{CAB}+\angle{BAI}=\angle{CMB}+\angle{BAI}\\
  \shoveleft \angle{CIA}=\angle{AMC}+\angle{IAM}=\angle{CAB}+\angle{IAM}\\
  \shoveleft \angle{CAI}=\angle{CIA}\implies \angle{BAI}=\angle{IAM}\\
  \shoveleft \implies I \text{ is the incenter of }\triangle{IAB}\blacksquare
  \end{multline}
  $$
...
- Two circles $\odot{O_1}$ and $\odot{O_2}$ are inscribed in secant $AB$ of circle $\odot{O}$ and intersect at point $U, V$. $C$ is the midpoint of arc $\overset{\huge\frown}{AB}$ not containing the tangents of circles. Then $C$ is on the radical axis of $\odot{O_1}$ and $\odot{O_2}$, i.e., $UVC$ are collinear.
  ...
  ![image-20231220194321362](/assets/images/2023/image-20231220194321362.png)
  $$
  \begin{multline}
  \shoveleft \text{From above property we know that }C \text{ has the same power of point with respect to }\odot{O_1}\text{ and } \odot{O_2}\\
  \shoveleft \implies C \text{ is on radical axis of }\odot{O_1} \text{ and }\odot{O_2} \text{ by the definition of radical axis(see note for details)}\\
  \end{multline}
  $$
  **Note:**

  - [Radical Axis Handout](https://www.nycmathteam.org/wp-content/uploads/2020/10/NYC_Orange_RadicalAxis_Handout.pdf), [here](/assets/files/radical_axis/nyc_orange_radicalaxis_handout.pdf) for local copy.
...
- Two circles $\odot{O_1}$ and $\odot{O_2}$ are inscribed in secant $AB$ of circle $\odot{O}$ and are tangent to each other externally at point $E$. Let $D$ be the intersect of a common internal tangent to $\odot{O_1}$ and $\odot{O_2}$ with $\odot{O}$ on the same side of $AB$ as the small circles, then $E$ is the incenter of $\triangle{DAB}$.
  ...
  ![image-20231220215229929](L:\workspace\mwo\assets\images\2023\image-20231220215229929.png)
  $$
  \begin{multline}
  \shoveleft \text{When }\odot{O_1} \text{ and }\odot{O_2} \text{ are tangent, their radical axis is the common internal tangent }\\
  \shoveleft \implies \angle{CAE}=\angle{CAB}+\angle{BAE}=\angle{CDB}+\angle{BAE}\\
  \shoveleft \angle{CEA} = \angle{ADC} + \angle{EAD}=\angle{CDB}+ \angle{EAD}\\
  \shoveleft \angle{CAE}=\angle{CEA}\implies \angle{BAE}=\angle{EAD}\implies E \text{ is incenter of }\triangle{DAB}
  \end{multline}
  $$
...
* Let $H'$ be its mirror point about $AB$, then $H'$ is on $\odot{O_2}$
  ...
  ![image-20231204123628869](/assets/images/2023/image-20231204123628869.png)
