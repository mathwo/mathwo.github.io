...
\shoveleft \implies r=\bbox[5px, border: 1px solid black]{\dfrac{A}{C}(B+\sqrt{B^2+C})}\\
\shoveleft \text{For }r_1=6, r_2=7, r_3=8, A=336, B=146, C=6908\\
\shoveleft \implies r=\dfrac{336}{6908}(146+\sqrt{146^2+6908})=\bbox[5px, border: 1px solid black]{\dfrac{168}{11}}
\end{multline}
$$
